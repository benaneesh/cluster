...
$('.ok_button_outter_start').click(function () {
	...
	*/
	...
	{
	    $.get("/engine/user_uploaded_dataset/", {'algo':algo_name, 'data':data_name}, function(data)
	    {
	...
	{
		// send a "GET" to server
	    $.get("/engine/get_machine_learning_result_given_algorithm_and_dataset/", {'algo':algo_name, 'data':data_name}, function(data)
	    {
